...
const requiredSnippets = {
  "index.html": [
    ...
    'data-quick-action="copy-element"',
    'data-quick-action="paste-element"',
    'data-quick-action="layer-front"',
    'data-quick-action="layer-forward"',
    'data-quick-action="layer-backward"',
    'data-quick-action="layer-back"',
    'id="draftBar"',
    "科技小亮AGI",
  ...
  "app.js": [
    ...
    "function applyPreviewVisualEdit",
  ...
  "src/sourceMapping.js": [
    ...
    "export function findElementOuterSourceRange",
  ...
  "src/previewBridge.js": [
    "export function injectPreviewBridge",
    "window.__selectEditorElement",
    "window.__applyEditorStylePatches",
    "contenteditable",
    "editor:inline-text",
    "editor:replace-image-drop",
    "editor:image-focus",
    "editor:visual-edit",
  ...
  "src/visualEditing.js": ["export function createMovePatch", "export function createResizePatch", "export function createLayerPatch", "export function applyStylePatch"],
  "src/canvasLayout.js": [
