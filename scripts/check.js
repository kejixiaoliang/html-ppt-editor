...
const requiredSnippets = {
  ...
  "app.js": [
    ...
    "function startFloatingToolbarDrag",
    ...
    "project: projectState.createProjectState",
    "previewProtocol.previewMessageTypes",
    "editorActions.syncElementEdit",
  ...
  "src/previewBridge.js": ["export function injectPreviewBridge", "window.__selectEditorElement", "window.__clearEditorSelection", "contenteditable", "editor:inline-text", "editor:replace-image-drop", "editor:image-focus", "editor:dismiss-selection"],
  "src/canvasLayout.js": [
  ...
  "src/fileSystemAccess.js": ["export function supportsFilePicker", "export function supportsDirectoryPicker", "export async function readDirectoryProject"],
  ...
  "src/projectState.js": ["export function createProjectState", "export function applyImportedProject", "export function clearProjectState", "export function getProjectEntryLabel"],
  "src/selectionState.js": ["export function createSelectionState", "export function selectEditorElement", "export function updateSelectionRange", "export function clearSelectionState"],
  "src/previewProtocol.js": ["export const previewMessageTypes", "export function isPreviewMessage", "export function getPreviewMessageType"],
  "src/editorActions.js": ["export function syncElementEdit", "export function syncInlineTextEdit", "export function createImageReplacement", "export function updateImageReference", "export function applyImageFocus"],
  "server/index.js": ["/health", "text/html;charset=utf-8"],
  "README.md": ["npm start", "http://localhost:5178", "覆盖保存"],
